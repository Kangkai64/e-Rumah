...
import HomePage from "./client_controller/landing/HomePage";
import AboutUs from "./client_controller/landing/AboutUs";
import StepByStep from "./client_controller/landing/StepByStep";
import FAQs from "./client_controller/landing/FAQs";
...
import LoanDisbursementController from "./controllers/LoanDisbursementController.jsx";
    ...
    >
      ...
      >
        <div>
          ...
          <p style={{ margin: 0, color: "#666" }}>
            Securely shared medical document
          </p>
        </div>
        <button
      ...
      >
        <p style={{ marginBottom: "0.5rem" }}>
          <strong>Privacy Notice:</strong> This document contains confidential
          medical information. Please handle with care and do not share further
