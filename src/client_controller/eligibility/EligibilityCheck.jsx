...
const EligibilityCheck = () => {
  ...
  // Excluded postal codes (not eligible for e-Rumah)
  ...
  const advanceToNextField = (currentFieldName, newValue, isValid) => {
    ...
    if (currentFieldName === "isMalaysian" && newValue === "yes") {
      ...
      currentFieldName === "isPrimaryResidence" &&
      newValue === "yes"
    ) {
      setCurrentField(5);
      ...
      currentFieldName === "isOtherOwner55Plus" &&
      newValue === "yes"
    ) {
      setCurrentField(7);
    } else if (
      currentFieldName === "hasLegalProceedings" &&
      newValue === "no"
    ) {
      setCurrentField(8);
      ...
      currentFieldName === "willSettleOutstanding" &&
      newValue === "yes"
    ) {
      setCurrentField(9);
    } else if (
      currentFieldName === "isFreeFromEncumbrances" &&
      newValue === "yes"
    ) {
      setCurrentField(10);
    }
    ...
    switch (field) {
      case "isMalaysian":
        if (value !== "yes") {
          setErrors((prev) => ({
            ...prev,
            [field]: "Only Malaysian citizens are eligible",
          }));
          return false;
        }
        return true;
      ...
      case "postalCode":
        if (!/^\d{5}$/.test(value)) {
          setErrors((prev) => ({
            ...prev,
            [field]: "Please enter a valid 5-digit postal code",
          }));
          return false;
        }
        if (excludedPostalCodes.includes(value)) {
          setErrors((prev) => ({
            ...prev,
            [field]: "This postal code is not within the eligible areas",
          }));
          return false;
        }
        return true;
      ...
      case "dateOfBirth":
        if (!value) {
          setErrors((prev) => ({
            ...prev,
            [field]: "Please enter your date of birth",
          }));
          return false;
        }
        ...
        if (age < 55) {
          setErrors((prev) => ({
            ...prev,
            [field]: "You must be at least 55 years old",
          }));
          return false;
        }
      ...
      case "isPrimaryResidence":
        if (value !== "yes") {
          setErrors((prev) => ({
            ...prev,
            [field]: "Property must be your primary place of residence",
          }));
          return false;
        }
        return true;
      ...
      case "leaseTenure":
        if (value !== "yes") {
          setErrors((prev) => ({
            ...prev,
            [field]:
              "Lease tenure must be renewed to at least 90 years before submission",
          }));
          return false;
        }
        return true;
      ...
      case "ownedByTwo":
        if (value === "no") {
          setErrors((prev) => ({
            ...prev,
            [field]:
              "Property must be owned by maximum 2 people to be eligible",
          }));
          return false;
        }
        return true;
      ...
      case "isFamilyMember":
        if (value === "no") {
          setErrors((prev) => ({
            ...prev,
            [field]: "The other owner must be a family member",
          }));
          return false;
        }
        return true;
      ...
      case "isOtherOwner55Plus":
        if (value === "no") {
          setErrors((prev) => ({
            ...prev,
            [field]: "The other owner must be 55 years old or above",
          }));
          return false;
        }
        return true;
      ...
      case "hasLegalProceedings":
        if (value === "yes") {
          setErrors((prev) => ({
            ...prev,
            [field]:
              "You cannot have any legal or bankruptcy proceedings to be eligible",
          }));
          return false;
        }
        return true;
      ...
      case "willSettleOutstanding":
        if (value === "no") {
          setErrors((prev) => ({
            ...prev,
            [field]:
              "You must settle the outstanding loan/financing amount to be eligible",
          }));
          return false;
        }
        return true;
      ...
      case "isFreeFromEncumbrances":
        if (value !== "yes") {
          setErrors((prev) => ({
            ...prev,
            [field]: "Property must be free from encumbrances",
          }));
          return false;
        }
        return true;
          ...
          <div className="eligibility-hero-left">
            <div className="eligibility-hero-content">
              ...
              <p className="hero-subtitle">
                Complete the form below to Register your account! <br />
                <br />
                If you have already done eligibility criteria check, please
                proceed to Login.
              </p>
        ...
        <form onSubmit={handleSubmit} className="eligibility-form">
          <div className="questions-grid">
            ...
            <div className="questions-column">
              ...
              <div
                className={`eligibility-question ${isFieldEnabled(1) ? "enabled" : "disabled"}`}
              >
                ...
                <div className="question-content">
                  ...
                  {errors.isMalaysian && (
                    <p className="error-message">{errors.isMalaysian}</p>
                  )}
                </div>
              </div>
              ...
              <div
                className={`eligibility-question ${isFieldEnabled(2) ? "enabled" : "disabled"}`}
              >
                <div className="question-number">2</div>
                <div className="question-content">
                  <label className="question-label">
                    Please provide postal code of your residential property
                  </label>
                  <input
                    type="text"
                    inputMode="numeric"
                    ...
                    placeholder="Enter postal code (e.g. 41100)"
              ...
              <div
                className={`eligibility-question ${isFieldEnabled(3) ? "enabled" : "disabled"}`}
              >
              ...
              <div
                className={`eligibility-question ${isFieldEnabled(4) ? "enabled" : "disabled"}`}
              >
                <div className="question-number">4</div>
                <div className="question-content">
                  <label className="question-label">
                    Is the property your primary place of residence?
                  </label>
                  <div className="eligibility-radio-group">
                    <label className="radio-label">
                      <input
                        ...
                        onChange={() =>
                          handleChange("isPrimaryResidence", "yes")
                        }
                    ...
                    <label className="radio-label">
                      <input
                        ...
                        onChange={() =>
                          handleChange("isPrimaryResidence", "no")
                        }
                        disabled={!isFieldEnabled(4)}
                      />
                      <span>No</span>
                  ...
                  {errors.isPrimaryResidence && (
                    <p className="error-message">{errors.isPrimaryResidence}</p>
                  )}
                </div>
              </div>
              ...
              <div
                className={`eligibility-question ${isFieldEnabled(5) ? "enabled" : "disabled"}`}
              >
                ...
                <div className="question-content">
                  ...
                  <div className="eligibility-radio-group">
                    <label className="radio-label">
                      <input
                        ...
                        onChange={() =>
                          handleChange("propertyType", "freehold")
                        }
                    ...
                    <label className="radio-label">
                      <input
                        ...
                        onChange={() =>
                          handleChange("propertyType", "leasehold")
                        }
                        disabled={!isFieldEnabled(5)}
                      />
                      <span>Leasehold</span>
                  ...
                  {formData.propertyType === "leasehold" && (
                    <div className="inline-sub-question">
                      <label className="question-label">
                        If leasehold, is the lease tenure renewed to at least 90
                        years before submission of application to Cagamas?
                      </label>
                      <div className="eligibility-radio-group">
                        <label className="radio-label">
                          <input
                      ...
                      {errors.leaseTenure && (
                        <p className="error-message">{errors.leaseTenure}</p>
                      )}
                    </div>
                  )}
                </div>
              ...
              <div
                className={`eligibility-question ${isFieldEnabled(6) ? "enabled" : "disabled"}`}
              >
                ...
                <div className="question-content">
                  ...
                  {errors.isSoleOwner && (
                    <p className="error-message">{errors.isSoleOwner}</p>
                  )}
                  ...
                  {formData.isSoleOwner === "no" && (
                    <div className="inline-sub-question">
                      <label className="question-label">
                        If no, is the property owned by 2 people?
                      </label>
                      <div className="eligibility-radio-group">
                        <label className="radio-label">
                          <input
                      ...
                      {errors.ownedByTwo && (
                        <p className="error-message">{errors.ownedByTwo}</p>
                      )}
                    </div>
                  )}
                  ...
                  {formData.isSoleOwner === "no" &&
                    formData.ownedByTwo === "yes" && (
                      <div className="inline-sub-question">
                        <label className="question-label">
                          Is the other owner your family member?
                        </label>
                        <div className="eligibility-radio-group">
                          <label className="radio-label">
                            <input
                              ...
                              onChange={() =>
                                handleChange("isFamilyMember", "yes")
                              }
                          ...
                          <label className="radio-label">
                            <input
                              ...
                              onChange={() =>
                                handleChange("isFamilyMember", "no")
                              }
                              disabled={!isFieldEnabled(6.2)}
                            />
                            <span>No</span>
                  ...
                  {formData.isSoleOwner === "no" &&
                    formData.ownedByTwo === "yes" &&
                    formData.isFamilyMember === "yes" && (
                      <div className="inline-sub-question">
                        <label className="question-label">
                          Is the other owner 55 years old or above?
                        </label>
                        <div className="eligibility-radio-group">
                          <label className="radio-label">
                            <input
                              ...
                              onChange={() =>
                                handleChange("isOtherOwner55Plus", "yes")
                              }
                          ...
                          <label className="radio-label">
                            <input
                              ...
                              onChange={() =>
                                handleChange("isOtherOwner55Plus", "no")
                              }
                              disabled={!isFieldEnabled(6.3)}
                            />
                            <span>No</span>
            ...
            {/* End questions-column (left) */}
            {/* Right Column - Questions 7-9 */}
            <div className="questions-column">
              {/* Question 7: Legal Proceedings */}
              <div
                className={`eligibility-question ${isFieldEnabled(7) ? "enabled" : "disabled"}`}
              >
                ...
                <div className="question-content">
                  ...
                  <p className="question-description">
                    (i) have any legal proceedings, suit or action (whether
                    criminal or civil) is instituted against you or/and the
                    joint owner? or
                    <br />
                    <br />
                    (ii) have any bankruptcy proceedings or petition is being
                    commenced against you or/and the joint owner?
                  </p>
                  <div className="eligibility-radio-group">
                    <label className="radio-label">
                      <input
                        ...
                        onChange={() =>
                          handleChange("hasLegalProceedings", "yes")
                        }
                    ...
                    <label className="radio-label">
                      <input
                        ...
                        onChange={() =>
                          handleChange("hasLegalProceedings", "no")
                        }
                        disabled={!isFieldEnabled(7)}
                      />
                      <span>No</span>
              ...
              <div
                className={`eligibility-question ${isFieldEnabled(8) ? "enabled" : "disabled"}`}
              >
                <div className="question-number">8</div>
                <div className="question-content">
                  <label className="question-label">
                    Is your property mortgage free (i.e., no home
                    loans/financing remaining outstanding?)
                  </label>
                  <div className="eligibility-radio-group">
                    <label className="radio-label">
                      <input
                  ...
                  {errors.isMortgageFree && (
                    <p className="error-message">{errors.isMortgageFree}</p>
                  )}
                  ...
                  {formData.isMortgageFree === "no" && (
                    <div className="inline-sub-question">
                      <label className="question-label">
                        If no, does the current outstanding loan/financing
                        amount lower than the Maximum Lumpsum Amount (Click the
                        Reverse Mortgage Calculator below)?
                      </label>
                      <div className="eligibility-radio-group">
                        <label className="radio-label">
                          <input
                            ...
                            onChange={() =>
                              handleChange("loanLowerThanMax", "yes")
                            }
                        ...
                        <label className="radio-label">
                          <input
                            ...
                            onChange={() =>
                              handleChange("loanLowerThanMax", "no")
                            }
                  ...
                  {formData.isMortgageFree === "no" &&
                    formData.loanLowerThanMax === "no" && (
                      <div className="inline-sub-question">
                        <label className="question-label">
                          Do you intend to settle all remaining outstanding
                          loan/financing amount by yourself to redeem your
                          property from bank/current financer?
                        </label>
                        <div className="eligibility-radio-group">
                          <label className="radio-label">
                            <input
                              ...
                              onChange={() =>
                                handleChange("willSettleOutstanding", "yes")
                              }
                          ...
                          <label className="radio-label">
                            <input
                              ...
                              onChange={() =>
                                handleChange("willSettleOutstanding", "no")
                              }
              ...
              <div
                className={`eligibility-question ${isFieldEnabled(9) ? "enabled" : "disabled"}`}
              >
                <div className="question-number">9</div>
                <div className="question-content">
                  <label className="question-label">
                    Is your property free from encumbrances?
                  </label>
                  <p className="question-description">
                    Of concern: If you or your family have other financial
                    obligations, such as an outstanding home equity loan or
                    charges against title etc (including the amount loaned by
                    government to pay monthly rent) (Monthly financial
                    obligations), you are probably in some charge/lien with the
                    property.
                  </p>
                  <div className="eligibility-radio-group">
                    <label className="radio-label">
                      <input
                        ...
                        onChange={() =>
                          handleChange("isFreeFromEncumbrances", "yes")
                        }
                    ...
                    <label className="radio-label">
                      <input
                        ...
                        onChange={() =>
                          handleChange("isFreeFromEncumbrances", "no")
                        }
                        disabled={!isFieldEnabled(9)}
                      />
                      <span>No</span>
